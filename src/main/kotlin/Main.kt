import app.kundi.safelogs.core.*
...
class Main : CliktCommand(name = "swagger-dictionary",
    ...
    private val sourceFile by argument("sourceFile", help = "The source file to be sanitized (production log, csv, etc)").file(exists = true)
    private val targetFile by argument("targetFile", help = "The target path and file name").file(exists = false)
    ...
    private val organizationReplacement: String by option(help="Text to be replaced for each organization found").default("[ORGANIZATION]")
